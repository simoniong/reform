...
class NewActiveModelTest < MiniTest::Spec # TODO: move to test/rails/
  ...
  describe "::model_name" do
    ...
    it { form.class.model_name.route_key.must_equal "songs" }
    ...
    let (:class_with_isolated_model) {
      Class.new(Reform::Form) do
        ...
        model IsolatedEngine::Lyric
      end
    }

    it { class_with_isolated_model.model_name.must_be_kind_of ActiveModel::Name }
    it { class_with_isolated_model.model_name.to_s.must_equal "IsolatedEngine::Lyric" }
    it { class_with_isolated_model.model_name.route_key "lyrics" }
    ...
    it { class_with_namespace_model.model_name.to_s.must_equal "Engine::Lyric" }
    it { class_with_namespace_model.model_name.route_key "engine_lyrics" }
